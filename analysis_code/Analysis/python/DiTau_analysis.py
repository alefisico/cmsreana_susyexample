...
class Analysis(Module):
    def __init__(self, channel, isMC):
        ...
        self.cset = _core.CorrectionSet.from_file("SUS_ex/Analysis/tau_DeepTau2018v2p5_2022_postEE.json")
        ...
        self.cset2 = _core.CorrectionSet.from_file("SUS_ex/Analysis/muon_Z.json")
